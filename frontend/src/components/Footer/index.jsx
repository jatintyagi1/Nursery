        ...
        <footer className="text-light bg-dark p-4 p-md-5 footer-container">
            <div className="container">
                        ...
                        <div className="d-flex flex-column flex-md-row mt-3 mt-md-0">
                            <div className="mb-2 d-flex flex-column flex-sm-row align-items-sm-start flex-md-column col-md-4 col-lg-6 me-md-3">
                                ...
                                <div className='d-flex flex-column justify-content-start'>
                                    <p className='highlight-desc'>Let grow together!</p>
                                    <p className='desc'>
                            ...
                            <div className="d-flex flex-wrap justify-content-between align-items-start col-md-8 col-lg-6">
                                ...
                                <div className="d-flex flex-column align-items-start pe-3">
                                    ...
                                    <p><i className="far fa-address-card me-3 text-secondary"></i> Noida, Uttar Pradesh, India.</p>
                                    <p>
                ...
                <section className="d-flex flex-column justify-content-center justify-content-lg-between">
                    ...
                    <div>
                        <Link to="https://www.facebook.com" className="me-4 link-secondary">
                            <i className="fab fa-facebook-f"></i>
                        </Link>
                        <Link to="https://x.com/Jatin_Tyagi_1" className="me-4 link-secondary">
                            <i className="fab fa-twitter"></i>
                        </Link>
                        <Link to="https://www.instagram.com/jatin.tyagi.1/" className="me-4 link-secondary">
                            <i className="fab fa-instagram"></i>
                        </Link>
                        <Link to="https://www.linkedin.com/in/jatin-tyagi-4a46612b3/" className="me-4 link-secondary">
                            <i className="fab fa-linkedin"></i>
                        </Link>
                        <Link to="https://github.com/jatintyagi1" className="me-4 link-secondary">
