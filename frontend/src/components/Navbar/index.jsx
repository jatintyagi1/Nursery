            ...
            <div className="container-fluid">
                ...
                <div ref={dropdownNavBarRef} className={`collapse navbar-collapse justify-content-around transition ${navBarToggle ? "show " : ""}`}>
                    ...
                    <div className="navbar-nav d-flex justify-content-end">
                        ...
                        <div className="nav-item">
                            <Link className="nav-link" to='/login' onClick={() => setNavBarToggle(false)}>
                                <i className='fas fa-user-alt'></i> Login
                            </Link>
                        </div>
                        <div className="nav-item">
                            <Link style={{ position: "relative" }} className="nav-link" to="/cart" onClick={() => setNavBarToggle(false)}>
                                <i style={{ fontSize: "23px", color: 'white' }} className="fas fa-shopping-cart small"> </i>
                                <span style={{ fontSize: "10px", position: "absolute", top: "0px", left: "18px" }} className='badge bg-success'>{0}</span>
                                <span> Cart</span>
                            </Link>
                        </div>
                    </div>
